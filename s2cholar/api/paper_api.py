...
class PaperApi(object):
    ...
    def get_graph_get_paper_authors(self, paper_id, **kwargs):
        ...
        if kwargs.get('async_req'):
            return self.get_graph_get_paper_authors_with_http_info(paper_id, **kwargs)
        else:
            (data) = self.get_graph_get_paper_authors_with_http_info(paper_id, **kwargs)
            return data

    def get_graph_get_paper_authors_with_http_info(self, paper_id, **kwargs):
        """Details about a paper's authors
        ...
        if self.api_client.client_side_validation and ('paper_id' not in params or
            ...
            raise ValueError("Missing the required parameter `paper_id` when calling `get_graph_get_paper_authors`")
