...
class Error404(object):
    ...
    def error(self):
        ...
        Depending on the case, error message may be any of these: <ul>     <li><code>\"Paper/Author/Object not found\"</code></li>     <li><code>\"Paper/Author/Object with id ### not found\"</code></li> </ul>  # noqa: E501
